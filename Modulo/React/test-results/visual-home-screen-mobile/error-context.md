...
- Name: visual.spec.js >> home screen
- Location: tests/visual.spec.js:57:1
...
Call log:
  - waiting for locator('text=Continue in Demo Mode')
    - locator resolved to <button data-rac="" tabindex="0" type="button" class="demo-connect-btn" id="react-aria7176945048-:ri:" data-react-aria-pressable="true">Continue in Demo Mode</button>
