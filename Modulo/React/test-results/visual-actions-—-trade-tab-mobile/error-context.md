...
- Name: visual.spec.js >> actions — trade tab
- Location: tests/visual.spec.js:94:1
...
Call log:
  - waiting for locator('text=Continue in Demo Mode')
    - locator resolved to <button data-rac="" tabindex="0" type="button" class="demo-connect-btn" id="react-aria1101923565-:ri:" data-react-aria-pressable="true">Continue in Demo Mode</button>
