...
- Name: visual.spec.js >> markets screen
- Location: tests/visual.spec.js:62:1
...
Call log:
  - waiting for locator('text=Continue in Demo Mode')
    - locator resolved to <button data-rac="" tabindex="0" type="button" class="demo-connect-btn" id="react-aria6751491582-:ri:" data-react-aria-pressable="true">Continue in Demo Mode</button>
