...
- Name: visual.spec.js >> actions — swap tab
- Location: tests/visual.spec.js:88:1
...
Call log:
  - waiting for locator('text=Continue in Demo Mode')
    - locator resolved to <button data-rac="" tabindex="0" type="button" class="demo-connect-btn" id="react-aria6509765215-:ri:" data-react-aria-pressable="true">Continue in Demo Mode</button>
