...
- Name: visual.spec.js >> swap — amount entered
- Location: tests/visual.spec.js:117:1
...
Call log:
  - waiting for locator('text=Continue in Demo Mode')
    - locator resolved to <button data-rac="" tabindex="0" type="button" class="demo-connect-btn" id="react-aria7761566165-:ri:" data-react-aria-pressable="true">Continue in Demo Mode</button>
