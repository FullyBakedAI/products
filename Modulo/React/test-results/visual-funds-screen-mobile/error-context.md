...
- Name: visual.spec.js >> funds screen
- Location: tests/visual.spec.js:78:1
...
Call log:
  - waiting for locator('text=Continue in Demo Mode')
    - locator resolved to <button data-rac="" tabindex="0" type="button" class="demo-connect-btn" id="react-aria7455295614-:ri:" data-react-aria-pressable="true">Continue in Demo Mode</button>
