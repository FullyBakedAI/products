...
- Name: visual.spec.js >> activity screen
- Location: tests/visual.spec.js:70:1
...
Call log:
  - waiting for locator('text=Continue in Demo Mode')
    - locator resolved to <button data-rac="" tabindex="0" type="button" class="demo-connect-btn" id="react-aria2951635255-:ri:" data-react-aria-pressable="true">Continue in Demo Mode</button>
