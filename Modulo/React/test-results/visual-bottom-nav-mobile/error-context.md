...
- Name: visual.spec.js >> bottom nav
- Location: tests/visual.spec.js:129:1
...
Call log:
  - waiting for locator('text=Continue in Demo Mode')
    - locator resolved to <button data-rac="" tabindex="0" type="button" class="demo-connect-btn" id="react-aria7712215012-:ri:" data-react-aria-pressable="true">Continue in Demo Mode</button>
